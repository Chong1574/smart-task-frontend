...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { AccountType, AccountSubType, TransactionType, Account, Transaction, Subscription, FuelLog, Vehicle } from '../../stores/finance'
  import('../../stores/finance')
  // @ts-ignore
  export type { Task, Project, Goal, Habit, HabitLog } from '../../stores/tasks'
  import('../../stores/tasks')
}
